...
const faqsData = [
  {
    ...
    answer: "The initiative provides selected NGOs and eligible purpose-led organizations with an opportunity to showcase and sell their products through the Native91 curated marketplace."
  },
  {
    question: "Is there a commission on NGO sales?",
    answer: "Native91 takes 0% commission on eligible NGO product sales under the Social Impact Initiative. The entire value goes toward your organization's mission."
  },
  {
    question: "What types of NGOs can apply?",
    answer: "NGOs and eligible organizations that create, source or develop products as part of livelihood, fundraising, community development or other social initiatives are encouraged to apply."
  },
  {
    question: "What products can be listed?",
    answer: "We are open to a variety of meaningful products, including handmade products, art and craft, food and gourmet products, home décor, sustainable products, gifts, hampers and community-made products."
  },
  {
    question: "Are all applications accepted?",
    answer: "Native91 follows a curation process to ensure participating products meet the marketplace's quality, presentation and category standards."
  },
  {
    question: "How can an NGO participate?",
    answer: "Submit an NGO invitation request with details about your organization and products. Our team will review the information and get in touch with the next steps."
  }
];
...
const Socialimpact = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.causeDescription.trim()) {
      errors.causeDescription = "Please describe the cause or mission supported";
    }
    ...
    <div className="social-impact-page lexend">
      ...
      <section className="si-hero text-center">
        <Container>
          ...
          >
            ...
            <h2>At Native91, we believe a product can do more than create value for the buyer.</h2>
            <div className="si-gold-divider"></div>
            <p className="si-hero-desc">
              It can create livelihoods. Support communities. Preserve traditional skills.
              And contribute to a cause that matters. We are opening our curated marketplace
              to selected NGOs and purpose-led organizations.
            </p>
            <div className="si-hero-actions">
              <button onClick={() => scrollToSection("ngo-form")} className="si-btn si-btn-gold">
                Partner With Native91
              </button>
              <button onClick={() => scrollToSection("why-section")} className="si-btn si-btn-outline">
          ...
          <Row className="align-items-center">
            <Col lg={6}>
              ...
              >
                ...
                <p className="si-why-text">
                  Across India, NGOs and community organizations create products that carry stories,
                  skills and purpose. From handmade crafts and sustainable products to food, home décor
                  and community-made goods, these products represent much more than meets the eye.
                </p>
                <p className="si-why-text mt-3">
                  Yet, reaching the right customers can be challenging. Native91 wants to help bridge that gap
                  by bringing selected NGO-created products onto a curated marketplace, making them easier to
                  discover while creating another avenue for organizations to generate revenue for their missions.
                </p>
              </motion.div>
            </Col>
            <Col lg={6} className="mt-5 mt-lg-0">
              ...
              >
                ...
                <p className="si-why-text">
                  We bring the same thoughtful shopping experience Native91 is known for to products created through meaningful social initiatives.
                </p>
              </motion.div>
            </Col>
          </Row>
      ...
      <section className="si-commitment-section">
        <Container>
          ...
          >
            <h6 className="text-uppercase text-center mb-3" style={{ letterSpacing: "3px", color: "#c8a96b" }}>
              Our Commitment
            </h6>
            <h2>0% Commission for Eligible NGO Sales.</h2>
            <div className="si-gold-divider"></div>
            <p className="si-stat-desc">
              We believe the value created through your products should contribute to the work you are doing.
              That's why Native91 takes zero commission from eligible NGO sales under this initiative.
            </p>
            ...
            <p className="si-stat-disclaimer">
              *No profit share is taken by Native91 from eligible NGO product sales under the Social Impact Initiative.*
            </p>
          </motion.div>
        </Container>
      </section>
          ...
          <Row className="g-5">
            <Col lg={5}>
              ...
              >
                ...
                <p className="mb-4">
                  The Native91 Social Impact Initiative is designed for NGOs and eligible purpose-led organizations that create, source or develop products as part of their programs:
                </p>
      ...
      <section className="si-quote-section">
        <Container>
          ...
          >
            <blockquote>
              "When a product carries a purpose, <span>the right customer should be able to find it.</span>"
            </blockquote>
            <p>Native91 — Supporting homegrown brands, communities and meaningful causes.</p>
          </motion.div>
        </Container>
      </section>
      ...
      {/* Bottom CTA */}
      <section className="cta-section py-5 text-center text-white" style={{ background: "#08281f" }}>
        <Container>
          <motion.div
          ...
          >
            ...
            <p className="mt-3">
              If your organization creates products that create meaningful impact, we'd love to explore what we can build together.
            </p>
            <button onClick={() => scrollToSection("ngo-form")} className="si-btn si-btn-gold mt-4">
